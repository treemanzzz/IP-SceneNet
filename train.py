...
from core.FusionNet import FusionNet, get_loss
...
def main():
    ...
    writer = SummaryWriter(
        "/home/ExtraData/SceneClass/results/ex08_a3-only/metrics"
    )
    ...
    for epoch in range(100):
        ...
        if accuracy > best_acc:
            ...
            torch.save(
                ...
                "/home/ExtraData/SceneClass/results/ex08_a3-only/weights/"
                + str(epoch)
                +"_OA"
                + ".path",
            )
    ...
    torch.save(
        classifier.state_dict(),
        "/home/ExtraData/SceneClass/results/ex08_a3-only/weights/final.pth",
    )
