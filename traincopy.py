...
def main():
    ...
    writer = SummaryWriter(
        "/home/ExtraData/SceneClass/results/ex07_a2-only/metrics"
    )
    ...
    for epoch in range(100):
        ...
        if accuracy > best_acc:
            ...
            torch.save(
                ...
                "/home/ExtraData/SceneClass/results/ex07_a2-only/weights/"
                + str(epoch)
                +"_OA"
                + ".path",
            )
    ...
    torch.save(
        classifier.state_dict(),
        "/home/ExtraData/SceneClass/results/ex07_a2-only/weights/final.pth",
    )
