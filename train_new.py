...
from newcore.IVNet import IVNet, get_loss
from newcore.dataset import SceneDataset
...
def main():
    ...
    train_dataset = SceneDataset("/home/ExtraData/SceneClass/Data/train_data", 0.0039)
    test_dataset = SceneDataset("/home/ExtraData/SceneClass/Data/test_data", 0.0039)
    ...
    writer = SummaryWriter(
        "/home/ExtraData/SceneClass/results/ex11_attention/metrics"
    )
    ...
    for epoch in range(100):
        ...
        if accuracy > best_acc:
            ...
            torch.save(
                ...
                "/home/ExtraData/SceneClass/results/ex11_attention/weights/"
                + str(epoch)
                +"_OA"
                + ".path",
            )
    ...
    torch.save(
        classifier.state_dict(),
        "/home/ExtraData/SceneClass/results/ex11_attention/weights/final.pth",
    )
