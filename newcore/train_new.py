...
from IVNet import IVNet, get_loss
...
def main():
    ...
    train_dataset = SceneDataset("/home/seer/CodingHere/WenJiangTian/SceneClass_/Data/train_data", 0.0039)
    test_dataset = SceneDataset("/home/seer/CodingHere/WenJiangTian/SceneClass_/Data/test_data", 0.0039)
    ...
    classifier = IVNet(num_class=7).cuda()
    ...
    writer = SummaryWriter(
        "/home/seer/CodingHere/WenJiangTian/SceneClass_/results/ex14_attention-no-res/metrics"
    )
    ...
    for epoch in range(100):
        ...
        if accuracy > best_acc:
            ...
            torch.save(
                ...
                "/home/seer/CodingHere/WenJiangTian/SceneClass_/results/ex14_attention-no-res/weights/"
                + str(epoch)
                +"_OA"
                + ".path",
            )
    ...
    torch.save(
        classifier.state_dict(),
        "/home/seer/CodingHere/WenJiangTian/SceneClass_/results/ex14_attention-no-res/weights/final.pth",
    )
